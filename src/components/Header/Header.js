      ...
      <div className="relative z-20 md:px-20">
        <div className="flex items-center justify-between px-4 py-5 sm:px-6 sm:py-4 md:justify-start md:space-x-10 lg:px-8">
          ...
          <div className="-my-2 -mr-2 md:hidden">
            <Popover.Button className="inline-flex text-white items-center justify-center rounded-md bg-transparent p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
